...
**NOTE: This is a toy package created for learning purposes, following
the second edition of [R Packages](https://r-pkgs.org). It is not meant
...
devtools::install_github("JLHerreraCortijo/regexcite")
```
